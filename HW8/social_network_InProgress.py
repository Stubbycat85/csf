...
rj=nx.Graph()
rj.add_nodes_from(['Nurse','Juliet','Tybalt','Capulet','Friar Laurence','Romeo',
'Montague','Benvolio','Escalus','Paris','Mercutio'])
rj.add_edges_from([('Paris','Escalus'),('Paris','Capulet'),('Paris','Mercutio')])
rj.add_edges_from([('Escalus','Capulet'),('Escalus','Mercutio'),('Escalus','Montague')])
rj.add_edge('Mercutio','Romeo')
rj.add_edge('Montague','Benvolio') 
rj.add_edge('Benvolio','Romeo') 
rj.add_edges_from([('Romeo','Friar Laurence'),('Romeo','Juliet'),('Romeo','Montague')])
rj.add_edge('Friar Laurence','Juliet')
rj.add_edges_from([('Juliet','Capulet'),('Juliet','Tybalt'),('Juliet','Nurse')])
...
def friends_of_friends(graph, user):
    ...
    f_of_f = ([])
    #for n in rj.neighbors('Mercutio'):
     #   n = rj.neighbors(n)
      #  f_of_f += n
       # friends_of_friends = set(f_of_f)
